    ...
    pug: {
      compile: {
        ...
        files: [{
          expand: true,
          cwd: '<%= meta.views %>',
          //src: ['**/*company-list.pug', '**/*company-edit.pug', '**/*add-new-company.pug', '**/*account-create.pug', '**/*account-edit.pug', '**/*account-detail.pug', '**/*create-booking.pug', '**/*edit-booking.pug', '**/*create-booking-new.pug', '**/*edit-booking-new.pug', '**/*booking-history.pug', '**/*booking-progress-new.pug', '**/*extra-cost.pug', '**/*new-extra-cost.pug', '**/*cost-center.pug', '**/*create-cost-center.pug', '**/*edit-cost-center.pug', '**/*index.pug', '**/*generate-invoice-page.pug', '**/*generate-invoice-page-new.pug', '!blocks/**', '!layouts/**', '!mixins/**'],
